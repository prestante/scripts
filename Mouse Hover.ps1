...
$ShowHelp1 = {$tooltip.SetToolTip($this,"$([System.Windows.Forms.Control]::MousePosition.x),$([System.Windows.Forms.Control]::MousePosition.y)")}
...
$text1.width=205
$text1.Name="text1"
$text1.add_MouseHover($ShowHelp1)
...
$check1.Left=15
$check1.Name="check1"
$check1.add_MouseHover($ShowHelp1)
$check1.Checked=$True
...
$check2.Left=15
$check2.Name="Check2"
$check2.add_MouseHover($ShowHelp1)
...
$check3.Left=15
$check3.Name="Check3"
$check3.add_MouseHover($ShowHelp1)
