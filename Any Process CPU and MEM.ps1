        ...
        if ($key.keydown) {
            switch ($key.VirtualKeyCode) {
                ...
                <#R#> 82 {
                    ...
                    $scriptFile = ".\Chart Builder.ps1" 
                    Start-Process powershell.exe -ArgumentList '-File ".\Chart Builder.ps1" -logfile $logfile -mode $mode" -RedirectStandardError "C:\PS\Logs\ErrorLog.txt'
                    }
