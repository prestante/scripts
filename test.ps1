...
# I want this variant to use one infinite job for every CTC, which (job) will just gather all data from its CTC and continuously return it to the main script. 
# The memory is ...
