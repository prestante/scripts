# http://192.168.13.69:10046/api/ListService/GetList?server=GALK&listIndex=1
$server = '192.168.13.30'
$port = '10046'
$url = "http://$server`:$port/api/ListService/GetList"
$swagger = "http://$server`:$port/api/ListService/help/index#!/ListService/ListService_GetList"
$params = @{
    server='CTC01'
    listIndex='1'
}
